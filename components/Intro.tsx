            ...
            <div className="pt-4 mx-auto">
                <div className="flex flex-col md:mx-20 mx-2 bg-gradient-to-b from-transparent to-pink-200 rounded-3xl h-auto opacity-80">
                    <div className="justify-center space-between mx-auto">
                        <a href="https://www.linkedin.com/in/kevin-s-24700b203/" target="_blank" rel="noopener noreferrer"><button className='items-center mr-3 border border-blue-400 hover:bg-blue-800 hover:text-white rounded outline-none focus:outline-none bg-transparent text-blue-300 text-sm py-1 px-2'>LinkedIn</button></a>
                        ...
                        <a href="#Projects"><button className='items-center ml-3 border border-green-400 hover:bg-green-500 hover:text-white rounded outline-none focus:outline-none bg-transparent text-green-300 text-sm py-1 px-2'>Projects</button></a>
                    </div>
